...
import env from "../../env";
const perPage = 10;
function StockResultBulk(props){
    const options=["عملیات","sku","برند","طراحی","لنز","قیمت واحد(راست)",
           "تخفیف"];
    const rowSpan=["2","2","1","2","1","2","2"]
    const colSpan=["1","1","4","1","3","1","1"]
...
export default StockResultBulk